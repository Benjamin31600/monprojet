export const site = {
  ...
  description:
    "Trouvez une garderie, un CPE ou une solution de garde au Québec. MyCoco aide les familles à trouver la bonne solution, puis à découvrir les services utiles autour de l’enfant.",
  locale: "fr_CA",
  country: "CA",
  region: "Quebec",
  currency: "CAD",
