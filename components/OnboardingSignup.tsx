...
export default function OnboardingSignup({ locale, role, returnTo }: { locale: Locale; role: Role; returnTo: string }) {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    if (!canContinue) { event.preventDefault(); return; }
    if (step < 4) {
      next(event);
      return;
    }
  ...
  return (
    <form className="mc-onboarding" action={family ? "/api/famille/inscription" : "/api/providers/register"} method="post" onSubmit={submit}>
      ...
      <style>{`
        .mc-onboarding{background:#fffdfa;border:1px solid #e2ddd4;border-radius:26px;padding:28px;box-shadow:0 24px 65px rgba(29,34,64,.12);color:#1d2240}.mc-onboarding-head{display:flex;justify-content:space-between;align-items:flex-end;gap:16px}.mc-onboarding-head div{display:grid;gap:4px}.mc-onboarding-head span{font-size:14px;font-weight:950;letter-spacing:.15em;color:#9e5a4a}.mc-onboarding-head strong{font-size:14px}.mc-onboarding-head small{max-width:190px;text-align:right;color:#8b8f9d;font-size:14px;line-height:1.35}.mc-onboarding-progress{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;margin:13px 0 30px}.mc-onboarding-progress i{height:4px;border-radius:999px;background:#e8e1d9}.mc-onboarding-progress i.active{background:#1d2240}.mc-onboarding section{min-height:385px}.mc-onboarding-number{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;background:#f0e8fb;color:#5e4e81;font-weight:950;font-size:14px}.mc-onboarding h2{font-size:30px;line-height:1.02;letter-spacing:-.05em;margin:17px 0 9px}.mc-onboarding section>p{max-width:520px;color:#72778b;font-size:14px;line-height:1.55;margin:0 0 22px}.mc-onboarding label{display:grid;gap:6px;margin-top:12px}.mc-onboarding label>span{font-size:14px;font-weight:900;color:#596074}.mc-onboarding input,.mc-onboarding select{width:100%;height:45px;border:1px solid #dbd7cf;border-radius:11px;background:#fff;color:#1d2240;padding:0 12px;font:inherit;font-size:14px;outline:none}.mc-onboarding input:focus,.mc-onboarding select:focus{border-color:#c57b61;box-shadow:0 0 0 3px rgba(197,123,97,.12)}.mc-onboarding-two{display:grid;grid-template-columns:1fr 1fr;gap:12px}.mc-onboarding-choice-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-bottom:14px}.mc-onboarding-choice-grid button{min-height:58px;border:1px solid #e1dcd4;border-radius:12px;background:#fff;text-align:left;padding:10px 11px;font-size:14px;font-weight:800;color:#28304b;cursor:pointer;position:relative}.mc-onboarding-choice-grid button span{position:absolute;right:11px;top:10px;color:#b55f49}.mc-onboarding-choice-grid button.selected{border-color:#b55f49;background:#fbefe9;box-shadow:0 0 0 2px rgba(181,95,73,.07)}.mc-onboarding-info{margin-top:14px;background:#f3f0fa;border:1px solid #e2dcef;border-radius:14px;padding:13px}.mc-onboarding-info strong{font-size:14px}.mc-onboarding-info p{margin:5px 0 0;color:#7b7f90;font-size:14px;line-height:1.5}.mc-onboarding-summary{display:grid;gap:4px;margin-top:18px;padding:13px;border-radius:13px;background:#f4f0e9;border:1px solid #ebe6dd}.mc-onboarding-summary strong{font-size:14px;text-transform:uppercase;letter-spacing:.1em;color:#8b675d}.mc-onboarding-summary span{font-size:14px;color:#5c6174}.mc-onboarding-actions{display:flex;align-items:center;justify-content:space-between;gap:12px;padding-top:18px;border-top:1px solid #eee9e2}.mc-onboarding-back{border:0;background:none;color:#74798b;font-size:14px;font-weight:900;cursor:pointer}.mc-onboarding-next{min-height:47px;border:0;border-radius:11px;padding:0 16px;background:#1d2240;color:#fff;font-size:14px;font-weight:950;cursor:pointer;box-shadow:0 9px 20px rgba(29,34,64,.15)}.mc-onboarding-next:hover{background:#14182f;transform:translateY(-1px)}.mc-onboarding-next:disabled{opacity:.42;cursor:not-allowed;transform:none}.mc-onboarding-next b{font-size:14px}.mc-onboarding-foot{text-align:center;color:#9699a5;font-size:14px;margin:10px 0 0;line-height:1.4}@media(max-width:650px){.mc-onboarding{padding:19px;border-radius:20px}.mc-onboarding-head small{display:none}.mc-onboarding section{min-height:400px}.mc-onboarding h2{font-size:26px}.mc-onboarding-two,.mc-onboarding-choice-grid{grid-template-columns:1fr}.mc-onboarding-actions{padding-top:14px}}
      `}</style>
    </form>
  );
}
