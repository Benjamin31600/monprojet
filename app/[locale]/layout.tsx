...
export default async function LocaleLayout({ children, params }: { children: React.ReactNode; params: Promise<{ locale: string }> }) {
  ...
  return <>
    ...
    <header className="site-header mc-site-header">
      ...
      <div className="mc-launchbar"><div className="mc-launchbar-inner"><span className="mc-launch-dot" aria-hidden="true" /><strong>{fr ? "MyCoco commence par votre besoin." : "MyCoco starts with your need."}</strong><span>{fr ? "Quelques critères. Des solutions plus pertinentes." : "A few criteria. More relevant options."}</span><Link href={`/${locale}/mon-besoin`}>{fr ? "Commencer →" : "Start →"}</Link></div></div>
    </header>
