      ...
      <body>
        <header className="site-header">
          ...
          <nav aria-label="Navigation principale">
            <a href="/garderies">Garderies</a>
            <a href="/garderie-subventionnee">Garderie subventionnée</a>
            <a href="/cpe">CPE</a>
        ...
        <footer className="site-footer">
          ...
          <div className="footer-links"><a href="/confidentialite">Confidentialité</a><a href="/conditions">Conditions</a></div>
        </footer>
      </body>
    </html>
  );
